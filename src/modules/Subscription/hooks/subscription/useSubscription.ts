...
import { ISubscription, SubscriptionPlan, SubscriptionReturnType, SubscriptionStatus } from "../../interfaces/subscription/ISubscription";
...
export const useSubscription = (): SubscriptionReturnType => {
  ...
  const fetchSubscription = useCallback(async () => {
    ...
    try {
      ...
      if (subscriptionData) {
        const currentPlan = PlanService.getSubscriptionPlanByType(
