...
import { Home, BarChart3, Settings, User, Wallet, Grid, List, CreditCard, Package, DollarSign, LayoutDashboard, FolderClosed, Bookmark, PiggyBank } from 'lucide-react';
  ...
  return [
    {
      items: [
        ...
        { 
          label: 'AppLayout:navigation.cashAccountsNew', 
