...
export const LandingHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gradient-to-r from-[rgba(250,250,250,1)] via-[rgba(108,154,229,1)] to-[rgba(0,140,158,1)] dark:from-[hsla(210,13%,40%,1)] dark:via-[hsla(185,94%,7%,1)] dark:to-[hsla(0,100%,4%,1)] backdrop-blur-sm py-4 px-6 flex items-center justify-between shadow-sm border-b z-50">
