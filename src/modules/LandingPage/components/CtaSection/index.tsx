  ...
  return (
    <section className="py-8 px-4 bg-gradient-to-r from-[rgba(250,250,250,1)] via-[rgba(108,154,229,0.7)] to-[rgba(0,140,158,1)] dark:from-[hsla(210,13%,40%,1)] dark:via-[hsla(185,94%,7%,1)] dark:to-[hsla(0,100%,4%,1)]">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-xl font-bold mb-2 text-foreground">{t("cta.title")}</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4 max-w-xl mx-auto">
          {t("cta.description")}
        </p>
        <Button size="sm" asChild className="text-xs px-3 py-1 h-7 shadow-md hover:shadow-lg transition-all" onClick={handleCtaClick}>
          <Link to="/signup">
