...
export const StatementWarning: React.FC<StatementWarningProps> = ({ 
  ...
  if (isLoadingStatement) {
    return (
      <Alert className="mt-1 p-1.5 flex items-center gap-1.5">
        <Clock className="h-3 w-3 animate-spin shrink-0" />
        <AlertDescription className="text-[10px] pl-0">
  ...
  if (statementError) {
    return (
      <Alert variant="destructive" className="mt-1 p-1.5 flex items-center gap-1.5">
  ...
  if (statement.status === 'OPEN') {
    return (
      <Alert className="mt-1 p-1.5 border-green-500 flex items-center gap-1.5">
  ...
  if (statement.status === 'FUTURE') {
    return (
      <Alert className="mt-1 p-1.5 border-amber-500 flex items-center gap-1.5">
