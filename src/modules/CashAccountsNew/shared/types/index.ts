...
// Common types for the CashAccounts module
...
/**
 * Nakit Hesap Servis İşlem Sonucu
 */
export interface CashAccountResult<T = CashAccount> {
  success: boolean;
  data?: T;
  error?: string;
}
...
/**
 * Nakit Hesap Servis İşlem Listesi Sonucu
 */
export interface CashAccountListResult<T = CashAccount> {
  success: boolean;
  data?: T[];
  error?: string;
}
