...
import { CategoryManagementService } from '@/modules/Categories/services/CategoryManagementService';
import { SubcategoryService } from '@/modules/Categories/services/SubcategoryService';
import type { ICategory, ICreateCategoryData, ICreateSubCategoryData } from '@/modules/Categories/types';
 ...
 */
export class TemplateImportService extends BaseTemplateService {
  private categoryService: CategoryManagementService;
  private subcategoryService: SubcategoryService;

  constructor() {
    super('CategoryTemplates.Import');
